...
import PlaceEtcInput from '@/app/(fullscreen)/plans/[articleId]/_components/modals/PlaceEtcInput';
import PlaceSearch from '@/app/(fullscreen)/plans/[articleId]/_components/modals/PlaceSearch';
import PlaceSearchTransport from '@/app/(fullscreen)/plans/[articleId]/_components/modals/PlaceSearchTransport';
import {
  OnEtcSelect,
  OnPlaceSelect,
  OnTransportSelect
